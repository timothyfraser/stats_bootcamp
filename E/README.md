# Module E: Sampling & Confidence Intervals

Module E introduces sampling distributions, confidence intervals, and the central limit theorem for making inferences about populations from samples.
...
- 💻 [E1_code.R](E1_code.R)
- 💻 [E1_code.py](E1_code.py)
- 💻 [E1_app.Rmd](E1_app.Rmd)
- 💾 [environmental_health.csv](environmental_health.csv)
