...
Module L introduces prediction and simulation techniques for using regression models to make predictions and simulate uncertainty in outcomes.
...
- 💻 [L1_code.R](L1_code.R)
- 💻 [L1_code.py](L1_code.py)
- 💾 [food_deserts.csv](food_deserts.csv)
